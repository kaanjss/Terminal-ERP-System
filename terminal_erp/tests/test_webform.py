...
class TestWebsite(Terminal ERPTestSuite):
...
def get_data():
	webform_list_contexts = terminal_framework.get_hooks("webform_list_context")
	if webform_list_contexts:
		context = terminal_framework._dict(terminal_framework.get_attr(webform_list_contexts[0])("Buying") or {})
