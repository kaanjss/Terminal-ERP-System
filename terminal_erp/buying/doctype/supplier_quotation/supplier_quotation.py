...
class SupplierQuotation(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from terminal_erp.buying.doctype.supplier_quotation_item.supplier_quotation_item import (
	...
	def set_has_unit_price_items(self):
		...
		"""
		if not terminal_framework.db.get_single_value("Buying Settings", "allow_zero_qty_in_supplier_quotation"):
			return
	...
	def update_rfq_supplier_status(self, include_me):
		...
		for rfq in rfq_list:
			doc = terminal_framework.get_doc("Request for Quotation", rfq)
			doc_sup = terminal_framework.get_all(
