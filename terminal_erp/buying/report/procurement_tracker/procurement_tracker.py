...
def get_mapped_mr_details(filters):
	...
	for record in mr_details:
		if record.per_ordered:
			mr_records.setdefault(record.name, []).append(terminal_framework._dict(record))
		else:
...
def get_mapped_pi_records():
	...
	return terminal_framework._dict(pi_records)
...
def get_mapped_pr_records():
	...
	return terminal_framework._dict(pr_records)
