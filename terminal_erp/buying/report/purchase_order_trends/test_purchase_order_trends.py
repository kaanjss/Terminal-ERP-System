...
class TestPurchaseOrderTrends(Terminal ERPTestSuite):
	def test_supplier_with_divergent_stored_name_stays_one_row(self):
		...
		from terminal_erp.buying.report.purchase_order_trends.purchase_order_trends import execute
		...
		terminal_framework.db.set_value("Purchase Order", po2.name, "supplier_name", "_Test Supplier (renamed)")
