...
# Embedded file name: /Users/anuragmishra/terminal_framework-develop/apps/terminal_erp/terminal_erp/buying/report/subcontracted_raw_materials_to_be_transferred/test_subcontracted_raw_materials_to_be_transferred.py
# Compiled at: 2019-05-06 10:24:35
# Decompiled by https://python-decompiler.com

import terminal_framework

from terminal_erp.buying.report.subcontracted_raw_materials_to_be_transferred.subcontracted_raw_materials_to_be_transferred import (
	execute,
)
...
class TestSubcontractedItemToBeTransferred(Terminal ERPTestSuite):
			...
			filters=terminal_framework._dict(
				{
					...
					"from_date": terminal_framework.utils.get_datetime(
						terminal_framework.utils.add_to_date(sco.transaction_date, days=-10)
					),
					"to_date": terminal_framework.utils.get_datetime(
						terminal_framework.utils.add_to_date(sco.transaction_date, days=10)
					),
				}
			)
