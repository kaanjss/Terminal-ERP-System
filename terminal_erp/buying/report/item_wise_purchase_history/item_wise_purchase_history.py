...
def get_supplier_details():
	details = terminal_framework.get_all("Supplier", fields=["name", "supplier_name", "supplier_group"])
	supplier_details = {}
	for d in details:
		supplier_details.setdefault(
			d.name,
			terminal_framework._dict({"supplier_name": d.supplier_name, "supplier_group": d.supplier_group}),
		)
...
def get_purchase_order_details(company_list, filters):
	db_po = terminal_framework.qb.DocType("Purchase Order")
	db_po_item = terminal_framework.qb.DocType("Purchase Order Item")

	query = (
		terminal_framework.qb.from_(db_po)
