...
from terminal_erp.assets.doctype.asset.test_asset import AssetSetup, create_asset
...
from terminal_erp.assets.report.fixed_asset_register.fixed_asset_register import execute


class TestFixedAssetRegister(AssetSetup):
	def run_report(self, **extra):
		filters = terminal_framework._dict(company="_Test Company", **extra)
	...
	def test_capitalized_asset_hidden_from_in_location_and_shown_in_disposed(self):
		...
		self.assertEqual(terminal_framework.db.get_value("Asset", consumed_asset.name, "status"), "Capitalized")
