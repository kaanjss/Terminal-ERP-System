...
from terminal_framework.utils.nestedset import NestedSet, update_nsm
...
class Location(NestedSet):
	...
	def update_ancestor_location_features(self):
		...
		for ancestor in self.get_ancestors():
			ancestor_doc = terminal_framework.get_doc("Location", ancestor)
...
def on_doctype_update():
	terminal_framework.db.add_index("Location", ["lft", "rgt"])
