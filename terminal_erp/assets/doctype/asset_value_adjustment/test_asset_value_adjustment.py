...
from terminal_framework.utils import add_days, cstr, get_last_day, getdate, nowdate
...
class TestAssetValueAdjustment(Terminal ERPTestSuite):
	def setUp(self):
	...
	def test_current_asset_value(self):
		...
		asset_doc = terminal_framework.get_doc("Asset", asset_name)
