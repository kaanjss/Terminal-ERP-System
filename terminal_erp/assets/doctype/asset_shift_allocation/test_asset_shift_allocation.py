...
class TestAssetShiftAllocation(Terminal ERPTestSuite):
	def setUp(self):
	...
	def test_asset_shift_allocation(self):
		...
		asset_shift_allocation = terminal_framework.get_doc(
		...
		asset_shift_allocation = terminal_framework.get_doc("Asset Shift Allocation", asset_shift_allocation.name)
...
def create_asset_shift_factors():
	...
	for s in shifts:
		terminal_framework.get_doc(s).insert()
