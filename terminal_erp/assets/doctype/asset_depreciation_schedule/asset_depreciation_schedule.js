...
terminal_framework.ui.form.on("Asset Depreciation Schedule", {
	onload: function (frm) {
...
terminal_framework.ui.form.on("Depreciation Schedule", {
	make_depreciation_entry: function (frm, cdt, cdn) {
		var row = locals[cdt][cdn];
		if (!row.journal_entry) {
			terminal_framework.call({
				method: "terminal_erp.assets.doctype.asset.depreciation.make_depreciation_entry",
				args: {
	...
	depreciation_amount: function (frm, cdt, cdn) {
		terminal_erp.asset.set_accumulated_depreciation(frm);
	},
});

terminal_erp.asset.set_accumulated_depreciation = function (frm) {
