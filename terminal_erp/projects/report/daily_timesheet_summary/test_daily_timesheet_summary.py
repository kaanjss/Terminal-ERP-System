...
from terminal_framework.utils import get_datetime, today

from terminal_erp.projects.doctype.timesheet.test_timesheet import make_timesheet
from terminal_erp.projects.report.daily_timesheet_summary.daily_timesheet_summary import execute
from terminal_erp.setup.doctype.employee.test_employee import make_employee
from terminal_erp.tests.utils import Terminal ERPTestSuite


class TestDailyTimesheetSummary(Terminal ERPTestSuite):
