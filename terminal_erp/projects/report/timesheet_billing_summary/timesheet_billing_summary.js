...
terminal_framework.query_reports["Timesheet Billing Summary"] = {
	tree: true,
	initial_depth: 0,
	filters: [
		{
		...
		},
		{
			...
			label: __("From Date"),
			fieldtype: "Date",
			default: terminal_framework.datetime.add_months(terminal_framework.datetime.month_start(), -1),
		},
		{
			fieldname: "to_date",
			label: __("To Date"),
			fieldtype: "Date",
			default: terminal_framework.datetime.add_days(terminal_framework.datetime.month_start(), -1),
		},
		{
