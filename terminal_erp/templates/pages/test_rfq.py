...
from terminal_erp.templates.pages.rfq import get_link_quotation
from terminal_erp.tests.utils import Terminal ERPTestSuite


class TestRFQPage(Terminal ERPTestSuite):
	...
	def test_get_link_quotation_returns_linked_quotation(self):
		...
		dup = terminal_framework.new_doc("Supplier Quotation Item")
		dup.update(sq.items[0].as_dict())
		dup.idx = sq.items[0].idx + 1
		dup.flags.name_set = True
		dup.name = terminal_framework.generate_hash("sqi-rfq", 12)
		dup.db_insert()
