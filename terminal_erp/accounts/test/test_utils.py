...
class TestUtils(Terminal ERPTestSuite):
	...
	def test_update_reference_in_payment_entry(self):
		...
		payment_reconciliation = terminal_framework.new_doc("Payment Reconciliation")
	...
	def test_naming_series_variable_parsing(self):
		...
		terminal_framework.db.set_default("supp_master_name", "Auto Name")
		...
		terminal_framework.db.set_default("supp_master_name", "Supplier Name")
