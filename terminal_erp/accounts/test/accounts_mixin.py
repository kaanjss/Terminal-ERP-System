...
class AccountsTestMixin:
	def create_customer(
		...
		if not terminal_framework.db.exists("Customer", customer_name):
			...
			if company and default_account:
				customer = terminal_framework.get_doc("Customer", customer_name)
				customer.accounts = []
				customer.append(
					"accounts",
					{
	...
	def create_company(self, company_name="_Test Company", abbr="_TC"):
		...
		if terminal_framework.db.exists("Company", company_name):
		...
		for acc in other_accounts:
			...
			if terminal_framework.db.exists("Account", acc_name):
				setattr(self, acc.attribute_name, acc_name)
			else:
				new_acc = terminal_framework.get_doc(
					{
						"doctype": "Account",
	...
	def identify_default_warehouses(self):
		for w in terminal_framework.db.get_all(
