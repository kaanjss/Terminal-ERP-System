...
from terminal_erp.accounts.doctype.finance_book.test_finance_book import create_finance_book
...
class TestPeriodClosingVoucher(Terminal ERPTestSuite):
	def setUp(self):
		super().setUp()
	...
	def test_gl_entries_restrictions(self):
		...
		self.assertRaises(terminal_framework.ValidationError, jv1.submit)
	...
	def test_closing_balance_with_dimensions_and_test_reposting_entry(self):
		...
		closing_balance = terminal_framework.db.get_value(
		...
		cc1_closing_balance = terminal_framework.db.get_value(
			"Account Closing Balance",
			{
				"account": "Sales - TPC",
				"cost_center": cost_center1,
		...
		cc2_closing_balance = terminal_framework.db.get_value(
			"Account Closing Balance",
			{
				"account": "Sales - TPC",
				"cost_center": cost_center2,
		...
		warehouse = terminal_framework.db.get_value("Warehouse", {"company": "Test PCV Company"}, "name")
	...
	def test_immutable_ledger_reverse_entry_uses_passed_posting_date_after_pcv(self):
		...
		totals_after_cancel = terminal_framework.get_all(
			"GL Entry",
...
def create_cost_center(cc_name):
	costcenter = terminal_framework.get_doc(
		{
			"company": "Test PCV Company",
