...
terminal_framework.ui.form.on("Period Closing Voucher", {
	onload: function (frm) {
		if (!frm.doc.transaction_date) frm.doc.transaction_date = terminal_framework.datetime.obj_to_str(new Date());
	...
	fiscal_year: function (frm) {
		if (frm.doc.fiscal_year) {
			terminal_framework.call({
				method: "terminal_erp.accounts.doctype.period_closing_voucher.period_closing_voucher.get_period_start_end_date",
				args: {
