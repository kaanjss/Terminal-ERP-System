...
from terminal_erp.accounts.doctype.tax_rule.tax_rule import ConflictingTaxRule, get_tax_template
...
class TestTaxRule(Terminal ERPTestSuite):
	def setUp(self):
		terminal_framework.db.set_single_value("Shopping Cart Settings", "enabled", 0)
	...
	def test_for_parent_supplier_group(self):
		...
		if not terminal_framework.db.exists("Purchase Taxes and Charges Template", purchase_template):
