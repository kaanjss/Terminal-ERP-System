...
from terminal_framework.utils import add_months, getdate
...
from terminal_erp.tests.utils import Terminal ERPTestSuite, if_lending_app_installed, if_lending_app_not_installed


class TestBankClearance(Terminal ERPTestSuite):
	def setUp(self):
	...
	def test_bank_clearance(self):
		bank_clearance = terminal_framework.get_doc("Bank Clearance")
	...
	def test_update_clearance_date_on_si(self):
		...
		si_clearance_date = terminal_framework.db.get_value(
...
def make_bank_account():
	if not terminal_framework.db.get_value("Account", "_Test Bank Clearance - _TC"):
...
def make_pos_sales_invoice():
	...
	mode_of_payment = terminal_framework.get_doc({"doctype": "Mode of Payment", "name": "Cash"})

	if not terminal_framework.db.get_value("Mode of Payment Account", {"company": "_Test Company", "parent": "Cash"}):
	...
	mode_of_payment = terminal_framework.get_doc("Mode of Payment", "Wire Transfer")
