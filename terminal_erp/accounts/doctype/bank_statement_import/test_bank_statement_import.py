# Copyright (c) 2020, Terminal Framework Technologies and Contributors
# See license.txt

from terminal_erp.accounts.doctype.bank_statement_import.bank_statement_import import (
	is_mt940_format,
...
class TestBankStatementImport(Terminal ERPTestSuite):
