...
from terminal_erp.accounts.doctype.process_period_closing_voucher.process_period_closing_voucher import (
...
class TestProcessPeriodClosingVoucher(Terminal ERPTestSuite):
	def setUp(self):
		terminal_framework.db.set_single_value("Accounts Settings", "use_legacy_controller_for_pcv", 0)
	...
	def make_process_pcv(self):
		...
		ppcv = terminal_framework.get_doc(
			{
	...
	def test_opening_balance_double_counting(self):
		...
		bal = terminal_framework.parse_json(
