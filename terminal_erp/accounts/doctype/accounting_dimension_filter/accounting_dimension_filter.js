...
terminal_framework.ui.form.on("Accounting Dimension Filter", {
	...
	setup_filters: function (frm) {
		...
		if (frm.doc.accounting_dimension) {
			terminal_framework.model.with_doctype(frm.doc.accounting_dimension, function () {
				if (terminal_framework.model.is_tree(frm.doc.accounting_dimension)) {
					filters["is_group"] = 0;
				}

				if (terminal_framework.meta.has_field(frm.doc.accounting_dimension, "company")) {
...
terminal_framework.ui.form.on("Allowed Dimension", {
