...
from terminal_erp.accounts.doctype.cost_center_allocation.cost_center_allocation import (
...
class TestCostCenterAllocation(Terminal ERPTestSuite):
	def setUp(self):
		cost_centers = [
			"Main Cost Center 1",
			"Main Cost Center 2",
	...
	@Terminal ERPTestSuite.change_settings("System Settings", {"rounding_method": "Commercial Rounding"})
...
def create_cost_center_allocation(
	...
	doc = terminal_framework.new_doc("Cost Center Allocation")
