...
from terminal_erp.stock.get_item_details import get_item_details
from terminal_erp.tests.utils import Terminal ERPTestSuite


class TestPricingRule(Terminal ERPTestSuite):
	def setUp(self):
		setup_pricing_rule_data()
		self.enterClassContext(self.change_settings("Selling Settings", validate_selling_price=0))

	def test_pricing_rule_for_discount(self):
		from terminal_framework import MandatoryError
		...
		terminal_framework.get_doc(test_record.copy()).insert()
		...
		prule = terminal_framework.get_doc(test_record.copy())
		prule.priority = 1
		...
		from terminal_erp.accounts.doctype.pricing_rule.utils import MultiplePricingRuleConflict
	...
	def test_pricing_rule_for_variants(self):
		...
		if not terminal_framework.db.exists("Item", "Test Variant PRT"):
	...
	def test_pricing_rule_for_stock_qty(self):
		...
		if not terminal_framework.db.get_value("UOM Conversion Detail", {"parent": "_Test Item", "uom": "box"}):
		...
		so.submit()
		so = terminal_framework.get_doc("Sales Order", so.name)
	...
	def test_pricing_rule_with_margin_and_discount(self):
		terminal_framework.delete_doc_if_exists("Pricing Rule", "_Test Pricing Rule")
		make_pricing_rule(
	...
	def test_dont_enforce_free_item_qty(self):
		...
		pricing_rule = terminal_framework.get_doc(test_record.copy()).insert()
	...
	def test_cumulative_pricing_rule(self):
		terminal_framework.delete_doc_if_exists("Pricing Rule", "_Test Cumulative Pricing Rule")
		test_record = {
			"doctype": "Pricing Rule",
			...
			"company": "_Test Company",
			"valid_from": terminal_framework.utils.nowdate(),
			"valid_upto": terminal_framework.utils.nowdate(),
		}
		terminal_framework.get_doc(test_record.copy()).insert()
		...
		args = terminal_framework._dict(
			{
				...
				"customer": "_Test Customer",
				"name": None,
				"transaction_date": terminal_framework.utils.nowdate(),
			}
		)
		details = get_item_details(args)
	...
	def test_multiple_pricing_rules(self):
		...
		terminal_framework.delete_doc_if_exists("Pricing Rule", "_Test Pricing Rule 1")
		terminal_framework.delete_doc_if_exists("Pricing Rule", "_Test Pricing Rule 2")
	...
	def test_item_price_with_pricing_rule(self):
		...
		rule = terminal_framework.get_doc(pricing_rule_record)
		rule.insert()
		...
		si.delete()
		rule.delete()
		terminal_framework.get_doc("Item Price", {"item_code": "Water Flask"}).delete()
		item.delete()
	...
	def test_item_price_with_blank_uom_pricing_rule(self):
		...
		si.delete()
		rule.delete()
		terminal_framework.get_doc("Item Price", {"item_code": "Item Blank UOM"}).delete()
	...
	def test_item_price_with_selling_uom_pricing_rule(self):
		...
		si.delete()
		rule.delete()
		terminal_framework.get_doc("Item Price", {"item_code": "Item UOM other than Stock"}).delete()

		item.delete()

	def test_item_group_price_with_blank_uom_pricing_rule(self):
		group = terminal_framework.get_doc(doctype="Item Group", item_group_name="_Test Pricing Rule Item Group")
		group.save()
		properties = {
		...
		si.delete()
		rule.delete()
		terminal_framework.get_doc("Item Price", {"item_code": "Item with Group Blank UOM"}).delete()
		item.delete()
		group.delete()

	def test_item_group_price_with_selling_uom_pricing_rule(self):
		group = terminal_framework.get_doc(doctype="Item Group", item_group_name="_Test Pricing Rule Item Group UOM")
		group.save()
		properties = {
		...
		si.delete()
		rule.delete()
		terminal_framework.get_doc("Item Price", {"item_code": "Item with Group UOM other than Stock"}).delete()
		item.delete()
		group.delete()
	...
	def test_pricing_rule_for_different_currency(self):
		...
		rule1 = terminal_framework.get_doc(pricing_rule_record)
		rule1.currency = "USD"
	...
	def test_multiple_pricing_rules_with_min_qty(self):
		...
		terminal_framework.delete_doc_if_exists("Pricing Rule", "_Test Pricing Rule with Min Qty - 1")
		terminal_framework.delete_doc_if_exists("Pricing Rule", "_Test Pricing Rule with Min Qty - 2")
	...
	def test_apply_multiple_pricing_rules_for_discount_percentage_and_amount(self):
		...
		terminal_framework.delete_doc_if_exists("Sales Order", so.name)
		terminal_framework.delete_doc_if_exists("Pricing Rule", "_Test Pricing Rule 1")
		terminal_framework.delete_doc_if_exists("Pricing Rule", "_Test Pricing Rule 2")
	...
	def test_pricing_rules_with_and_without_apply_multiple(self):
		...
		for item_group_priority, item_code_priority in [(2, 4), (4, 2)]:
			item_group_rule = terminal_framework.get_doc(test_records[0].copy())
			item_group_rule.priority = item_group_priority
			item_group_rule.insert()

			item_code_rule = terminal_framework.get_doc(test_records[1].copy())
	...
	def test_validation_on_mixed_condition_with_recursion(self):
		...
		self.assertRaises(terminal_framework.ValidationError, pricing_rule.save)
...
def setup_pricing_rule_data():
	if not terminal_framework.db.exists("UTM Campaign", "_Test Campaign"):
		terminal_framework.get_doc(
