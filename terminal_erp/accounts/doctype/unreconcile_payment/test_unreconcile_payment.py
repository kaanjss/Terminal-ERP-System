...
class TestUnreconcilePayment(Terminal ERPTestSuite, AccountsTestMixin):
	def setUp(self):
	...
	def test_07_adv_from_so_to_invoice(self):
		terminal_framework.db.set_value("Company", self.company, "book_advance_payments_in_separate_party_account", 1)
