...
from terminal_erp.accounts.report.financial_ratios.financial_ratios import execute
from terminal_erp.tests.utils import Terminal ERPTestSuite


class TestFinancialRatios(Terminal ERPTestSuite):
	def setUp(self):
	...
	def set_account_type(self, account_name, account_type):
		terminal_framework.db.set_value("Account", f"{account_name} - {self.abbr}", "account_type", account_type)
	...
	def get_report_filters(self):
		active_fy = terminal_framework.db.get_value(
			"Fiscal Year",
