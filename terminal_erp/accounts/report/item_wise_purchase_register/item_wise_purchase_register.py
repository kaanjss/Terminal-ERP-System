...
import terminal_erp
from terminal_erp.accounts.report.item_wise_sales_register.item_wise_sales_register import (
	add_sub_total_row,
	add_total_row,
...
def get_aii_accounts():
	return dict(terminal_framework.get_all("Company", fields=["name", "stock_received_but_not_billed"], as_list=True))


def get_purchase_receipts_against_purchase_order(item_list):
	po_pr_map = terminal_framework._dict()
	po_item_rows = list(set(d.po_detail for d in item_list))

	if po_item_rows:
		purchase_receipts = terminal_framework.get_all(
