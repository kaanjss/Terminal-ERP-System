...
def get_account_type_based_gl_data(company, filters=None):
	...
	if filters.include_default_book_entries:
		company_fb = terminal_framework.get_cached_value("Company", company, "default_finance_book")
		query = query.where(
...
def get_opening_range_using_fiscal_year(company, period_list):
	...
	earliest_fy = (
		terminal_framework.qb.from_(FiscalYear)
	...
	if not earliest_fy:
		terminal_framework.throw(_("Not able to find the earliest Fiscal Year for the given company."))
