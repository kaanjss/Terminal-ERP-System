...
terminal_framework.query_reports[CF_REPORT_NAME] = $.extend(terminal_erp.financial_statements, {
	name_field: "section",
	parent_field: "parent_section",
});

terminal_erp.utils.add_dimensions(CF_REPORT_NAME, 10);

// The last item in the array is the definition for Presentation Currency
// filter. It won't be used in cash flow for now so we pop it. Please take
// of this if you are working here.

terminal_framework.query_reports[CF_REPORT_NAME]["filters"].splice(8, 1);

terminal_framework.query_reports[CF_REPORT_NAME]["filters"].push(
	{
...
terminal_framework.query_reports[CF_REPORT_NAME]["export_hidden_cols"] = true;
