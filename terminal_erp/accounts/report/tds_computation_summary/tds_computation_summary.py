...
from terminal_erp.accounts.report.tax_withholding_details.tax_withholding_details import (
...
class TDSComputationSummaryReport(TaxWithholdingDetailsReport):
	...
	def validate_filters(self):
		...
		if from_year != to_year:
			terminal_framework.throw(_("From Date and To Date lie in different Fiscal Year"))
