...
from terminal_erp.accounts.report.consolidated_trial_balance.consolidated_trial_balance import execute
from terminal_erp.setup.utils import get_exchange_rate
from terminal_erp.tests.utils import Terminal ERPTestSuite


class ForeignCurrencyTranslationReserveNotFoundError(terminal_framework.ValidationError):
	pass


class TestConsolidatedTrialBalance(Terminal ERPTestSuite):
	def setUp(self):
	...
	def test_single_company_report(self):
		filters = terminal_framework._dict({"company": ["Parent Group Company India"], "fiscal_year": self.fiscal_year})
