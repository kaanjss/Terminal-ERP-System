...
from terminal_erp.accounts.report.balance_sheet.balance_sheet import execute
...
class TestBalanceSheet(Terminal ERPTestSuite):
...
def create_account(account_name: str, parent_account: str, company: str):
	if terminal_framework.db.exists("Account", {"account_name": account_name, "company": company}):
		return
