...
from terminal_erp.accounts.report.general_ledger.general_ledger import execute
from terminal_erp.controllers.sales_and_purchase_return import make_return_doc
from terminal_erp.tests.utils import Terminal ERPTestSuite


class TestGeneralLedger(Terminal ERPTestSuite):
	def setUp(self):
	...
	def test_gl_report_runs_with_remarks_length(self):
		...
		terminal_framework.db.set_single_value("Accounts Settings", "general_ledger_remarks_length", 50)
		self.addCleanup(terminal_framework.db.set_single_value, "Accounts Settings", "general_ledger_remarks_length", 0)
	...
	def test_foreign_account_balance_after_exchange_rate_revaluation(self):
		...
		revaluation = terminal_framework.new_doc("Exchange Rate Revaluation")
	...
	def test_ignore_cr_dr_notes_filter(self):
		...
		system_generated_journal = terminal_framework.db.get_all(
			"Journal Entry",
			filters={
				"docstatus": 1,
