...
from terminal_erp.accounts.report.accounts_receivable_summary.accounts_receivable_summary import execute
...
class TestAccountsReceivable(Terminal ERPTestSuite, AccountsTestMixin):
	...
	def test_01_receivable_summary_output(self):
		...
		customer_group, customer_territory = terminal_framework.db.get_all(
			"Customer",
	...
	@Terminal ERPTestSuite.change_settings("Selling Settings", {"cust_master_name": "Naming Series"})
