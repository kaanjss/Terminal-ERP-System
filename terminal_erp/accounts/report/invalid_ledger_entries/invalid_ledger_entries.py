...
def validate_filters(filters: dict | None = None):
	if not filters:
		terminal_framework.throw(_("Filters missing"))

	if not filters.company:
		terminal_framework.throw(_("Company is mandatory"))

	if filters.from_date > filters.to_date:
		terminal_framework.throw(_("Start Date should be lower than End Date"))
