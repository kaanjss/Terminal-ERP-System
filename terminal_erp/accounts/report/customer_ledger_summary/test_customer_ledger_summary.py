...
from terminal_erp.accounts.report.customer_ledger_summary.customer_ledger_summary import execute
...
class TestCustomerLedgerSummary(Terminal ERPTestSuite, AccountsTestMixin):
	def setUp(self):
