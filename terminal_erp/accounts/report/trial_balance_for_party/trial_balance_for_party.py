...
from terminal_erp.accounts.report.general_ledger.general_ledger import get_accounts_with_children
...
def get_data(filters, show_party_name):
	if filters.get("party_type") in ("Customer", "Supplier", "Employee", "Member"):
		party_name_field = "{}_name".format(terminal_framework.scrub(filters.get("party_type")))
	...
	parties = terminal_framework.get_all(
	...
	total_row = terminal_framework._dict(
		{
			"opening_debit": 0,
			"opening_credit": 0,
			"debit": 0,
...
def get_balances_within_period(filters, account_filter=None):
	...
	balances_within_period = terminal_framework._dict()
	for d in gle:
...
def is_party_name_visible(filters):
	...
	if filters.get("party_type") in ["Customer", "Supplier"]:
		if filters.get("party_type") == "Customer":
			party_naming_by = terminal_framework.get_single_value("Selling Settings", "cust_master_name")
		else:
			party_naming_by = terminal_framework.db.get_single_value("Buying Settings", "supp_master_name")
