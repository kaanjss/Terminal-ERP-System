...
from terminal_erp.accounts.report.accounts_payable.accounts_payable import execute
from terminal_erp.accounts.test.accounts_mixin import AccountsTestMixin
from terminal_erp.tests.utils import Terminal ERPTestSuite


class TestAccountsPayable(Terminal ERPTestSuite, AccountsTestMixin):
	def setUp(self):
	...
	def test_payment_terms_template_filters(self):
		...
		template = terminal_framework.get_doc("Payment Terms Template", "_Test Payment Term Template")
		first_term = terminal_framework.get_doc("Payment Term", template.terms[0].payment_term)
	...
	def test_project_filter(self):
		project = terminal_framework.get_doc("Project", {"project_name": "_Test Project"})
