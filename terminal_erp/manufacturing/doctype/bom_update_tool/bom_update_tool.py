...
from terminal_framework.utils import date_diff, get_datetime, now
...
def enqueue_replace_bom(boms: dict | str | None = None, args: dict | str | None = None) -> "BOMUpdateLog":
	...
	boms = boms or args
	boms = terminal_framework.parse_json(boms)
...
def auto_update_latest_price_in_all_boms() -> None:
	"""Called via hooks.py."""
	if terminal_framework.db.get_single_value("Manufacturing Settings", "update_bom_costs_automatically"):
