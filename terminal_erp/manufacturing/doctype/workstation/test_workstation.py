...
from terminal_erp.manufacturing.doctype.routing.test_routing import create_routing, setup_bom
from terminal_erp.manufacturing.doctype.workstation.workstation import (
...
class TestWorkstation(Terminal ERPTestSuite):
	...
	def test_update_bom_operation_rate(self):
		...
		w1 = terminal_framework.get_doc("Workstation", "_Test Workstation A")
		# resets values
		...
		routing_op_rate = terminal_framework.db.get_value(
			"BOM Operation",
...
def make_workstation(*args, **kwargs):
	...
	if not terminal_framework.db.exists("Workstation", workstation_name):
		doc = terminal_framework.get_doc({"doctype": "Workstation", "workstation_name": workstation_name})
	...
	return terminal_framework.get_doc("Workstation", workstation_name)
