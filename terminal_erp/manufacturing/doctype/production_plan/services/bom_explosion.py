...
from terminal_erp.manufacturing.doctype.production_plan.services.planning_queries import get_uom_conversion_factor
...
def _exploded_items_query(company, bom_no, include_non_stock_items, planned_qty):
	bei = terminal_framework.qb.DocType("BOM Explosion Item")
