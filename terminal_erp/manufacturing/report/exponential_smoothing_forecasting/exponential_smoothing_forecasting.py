...
from terminal_framework.utils import add_years, cint, flt, getdate
...
class ForecastingReport(ExponentialSmoothingForecast):
	def __init__(self, filters=None):
		...
		self.company_currency = terminal_erp.get_company_currency(self.filters.company)
	...
	def get_data_for_forecast(self):
		parent = terminal_framework.qb.DocType(self.doctype)
		child = terminal_framework.qb.DocType(self.child_doctype)
