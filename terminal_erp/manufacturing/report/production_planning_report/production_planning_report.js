...
terminal_framework.query_reports["Production Planning Report"] = {
	filters: [
		{
			fieldname: "company",
			label: __("Company"),
		...
		},
		{
			...
			on_change: function () {
				...
				let based_on = terminal_framework.query_report.get_filter_value("based_on");
				let options = {
		...
		},
		{
			...
			get_data: function (txt) {
				...
				return terminal_framework.db.get_link_options(based_on, txt);
			},
			get_query: function () {
