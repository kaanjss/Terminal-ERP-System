...
def get_item_list(wo_list, filters):
	...
	if wo_list:
		...
		for wo_details in wo_list:
			desc = terminal_framework.db.get_value("BOM", wo_details.bom_no, "description")

			for wo_item_details in terminal_framework.db.get_values(
...
def get_work_orders():
	out = terminal_framework.get_all(
		"Work Order",
