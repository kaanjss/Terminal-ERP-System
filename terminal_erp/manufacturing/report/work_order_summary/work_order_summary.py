...
from terminal_framework.utils import date_diff, flt, getdate, today

from terminal_erp.stock.report.stock_analytics.stock_analytics import get_period, get_period_date_ranges
...
def get_chart_based_on_status(data):
	labels = terminal_framework.get_meta("Work Order").get_options("status").split("\n")
	if "" in labels:
		labels.remove("")
