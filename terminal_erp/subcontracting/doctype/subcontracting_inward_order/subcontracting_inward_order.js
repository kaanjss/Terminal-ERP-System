...
terminal_framework.ui.form.on("Subcontracting Inward Order Item", {
	qty(frm, cdt, cdn) {
...
terminal_framework.ui.form.on("Subcontracting Inward Order", {
	setup: (frm) => {
	...
	update_subcontracting_inward_order_status(frm, status) {
		terminal_framework.call({
			method: "terminal_erp.subcontracting.doctype.subcontracting_inward_order.subcontracting_inward_order.update_subcontracting_inward_order_status",
			args: {
				scio: frm.doc.name,
				status: status,
			},
