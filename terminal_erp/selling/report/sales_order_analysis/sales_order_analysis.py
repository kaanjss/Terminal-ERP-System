...
from terminal_framework.query_builder import Case, CustomFunction
from terminal_framework.query_builder.functions import Coalesce, DateDiff, Max, Sum
from terminal_framework.utils import date_diff, flt, getdate, nowdate
...
def validate_filters(filters):
	...
	if not from_date and to_date:
		...
		terminal_framework.throw(_("To Date cannot be before From Date."))
