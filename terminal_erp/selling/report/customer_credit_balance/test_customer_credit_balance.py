...
from terminal_erp.selling.report.customer_credit_balance.customer_credit_balance import get_details
from terminal_erp.tests.utils import Terminal ERPTestSuite


class TestCustomerCreditBalance(Terminal ERPTestSuite):
	def test_get_details_returns_customer_with_credit_limit(self):
		...
		rows = get_details(terminal_framework._dict(company=company, customer=customer.name))
