...
from terminal_erp.selling.doctype.customer.customer import get_credit_limit, get_customer_outstanding
...
def execute(filters=None):
	...
	customer_naming_type = terminal_framework.get_single_value("Selling Settings", "cust_master_name")
...
def get_details(filters):
	c = terminal_framework.qb.DocType("Customer")
	ccl = terminal_framework.qb.DocType("Customer Credit Limit")
	query = (
