...
from terminal_erp.selling.report.sales_person_target_variance_based_on_item_group.sales_person_target_variance_based_on_item_group import (
	execute,
)
from terminal_erp.tests.utils import Terminal ERPTestSuite


class TestSalesPersonTargetVarianceBasedOnItemGroup(Terminal ERPTestSuite):
	def setUp(self):
...
def create_target_distribution(fiscal_year):
	distribution = terminal_framework.new_doc("Monthly Distribution")
...
def create_sales_target_doc(
	...
	sales_target_doc = terminal_framework.new_doc(sales_field_dt)
