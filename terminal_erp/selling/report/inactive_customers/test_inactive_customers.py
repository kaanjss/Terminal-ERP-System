...
from terminal_erp.selling.report.inactive_customers.inactive_customers import execute
from terminal_erp.tests.utils import Terminal ERPTestSuite


class TestInactiveCustomers(Terminal ERPTestSuite):
	def setUp(self):
		self.customer = terminal_framework.get_doc(doctype="Customer", customer_name="_Test Inactive Customer").insert()
