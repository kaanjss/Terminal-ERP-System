terminal_erp.PointOfSale.PastOrderList = class {
	...
	make_filter_section() {
		...
		this.status_field = terminal_framework.ui.form.make_control({
			df: {
	...
	refresh_list() {
		...
		return terminal_framework.call({
			method: "terminal_erp.selling.page.point_of_sale.point_of_sale.get_past_order_list",
			freeze: true,
	...
	get_invoice_html(invoice) {
		...
		return `<div class="invoice-wrapper" data-invoice-doctype="${
			invoice.doctype
		}" data-invoice-name="${terminal_framework.utils.escape_html(invoice.name)}">
				<div class="invoice-name-customer">
					<div class="invoice-customer">
						<svg class="mr-2" width="12" height="12" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
							<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>
						</svg>
						${terminal_framework.utils.escape_html(terminal_framework.ellipsis(invoice.customer_name, 20))}
					</div>
