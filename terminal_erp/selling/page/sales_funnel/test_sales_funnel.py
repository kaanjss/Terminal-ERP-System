...
from terminal_framework.utils import add_days, random_string, today
...
from terminal_erp.selling.page.sales_funnel.sales_funnel import get_funnel_data
from terminal_erp.tests.utils import Terminal ERPTestSuite


class TestSalesFunnel(Terminal ERPTestSuite):
