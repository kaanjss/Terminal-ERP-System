...
def make_quotation(source_name: str, target_doc: str | Document | None = None):
	...
	price_list, currency = terminal_framework.db.get_value(
...
def _set_missing_values(source, target):
	...
	if contact:
		...
		target.contact_display, target.contact_email, target.contact_mobile = terminal_framework.get_value(
...
def make_contact(args, is_primary_contact=1):
	...
	contact = terminal_framework.get_doc(values)
