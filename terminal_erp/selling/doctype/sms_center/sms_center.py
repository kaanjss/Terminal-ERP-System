...
from terminal_framework.core.doctype.sms_settings.sms_settings import send_sms
...
class SMSCenter(Document):
	...
	def get_contact_query_for_all_sales_person(self):
		SalesPerson = terminal_framework.qb.DocType("Sales Person")
		Employee = terminal_framework.qb.DocType("Employee")

		query = (
			terminal_framework.qb.from_(SalesPerson)
			.left_join(Employee)
