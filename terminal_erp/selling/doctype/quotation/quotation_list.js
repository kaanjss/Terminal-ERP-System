terminal_framework.listview_settings["Quotation"] = {
	...
	onload: function (listview) {
		...
		if (terminal_framework.model.can_create("Sales Order")) {
			listview.page.add_action_item(__("Sales Order"), () => {
				terminal_erp.bulk_transaction_processing.create(listview, "Quotation", "Sales Order");
			});
		}

		if (terminal_framework.model.can_create("Sales Invoice")) {
			listview.page.add_action_item(__("Sales Invoice"), () => {
				terminal_erp.bulk_transaction_processing.create(listview, "Quotation", "Sales Invoice");
			});
		}
	},
