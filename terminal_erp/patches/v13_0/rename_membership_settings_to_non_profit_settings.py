...
def execute():
	if terminal_framework.db.table_exists("Membership Settings"):
		terminal_framework.rename_doc("DocType", "Membership Settings", "Non Profit Settings")
		terminal_framework.reload_doctype("Non Profit Settings", force=True)

	if terminal_framework.db.table_exists("Non Profit Settings"):
		rename_fields_map = {
