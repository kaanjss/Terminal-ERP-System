...
from terminal_framework.utils import get_time, getdate, today
...
def execute():
	...
	for module, doctype in doctypes_to_reload:
		terminal_framework.reload_doc(module, "doctype", doctype)
	...
	terminal_framework.flags.warehouse_account_map = {}
	...
	if data:
		for row in terminal_framework.get_all("Company", filters={"enable_perpetual_inventory": 1}):
