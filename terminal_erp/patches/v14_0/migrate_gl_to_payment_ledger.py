...
from terminal_framework.query_builder import CustomFunction
from terminal_framework.query_builder.custom import ConstantColumn
from terminal_framework.query_builder.functions import Count, IfNull
...
def get_columns():
	...
	if terminal_framework.db.has_column("Payment Ledger Entry", "remarks"):
...
def execute():
	...
	if terminal_framework.reload_doc("accounts", "doctype", "payment_ledger_entry"):
