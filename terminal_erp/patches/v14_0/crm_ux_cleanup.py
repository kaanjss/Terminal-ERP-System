...
from terminal_framework.utils import add_months, cstr, today


def execute():
	for doctype in ("CRM Note", "Lead", "Opportunity", "Prospect", "Prospect Lead"):
		terminal_framework.reload_doc("crm", "doctype", doctype)
...
def add_calendar_event_for_leads():
	...
	leads = terminal_framework.db.sql(
		"""
...
def add_calendar_event_for_opportunities():
	# create events based on next contact date
	opportunities = terminal_framework.db.sql(
		"""
