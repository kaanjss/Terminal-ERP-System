...
def execute():
	...
	if not terminal_framework.get_meta("Journal Entry Account").has_field("bank_account"):
		terminal_framework.reload_doc("Accounts", "doctype", "Journal Entry Account")
...
def update_journal_entry_account_fieldname():
	...
	if terminal_framework.db.has_column("Journal Entry Account", "bank_account_no"):
