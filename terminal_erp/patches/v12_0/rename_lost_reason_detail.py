...
def execute():
	if terminal_framework.db.exists("DocType", "Lost Reason Detail"):
		terminal_framework.reload_doc("crm", "doctype", "opportunity_lost_reason")
		terminal_framework.reload_doc("crm", "doctype", "opportunity_lost_reason_detail")
		terminal_framework.reload_doc("setup", "doctype", "quotation_lost_reason_detail")
		...
		terminal_framework.delete_doc("DocType", "Lost Reason Detail")
