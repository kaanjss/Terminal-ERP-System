...
def execute():
	default_exchange_gain_loss_accounts = terminal_framework.get_all(
		"Company",
	...
	payment_entry_deduction = terminal_framework.qb.DocType("Payment Entry Deduction")

	terminal_framework.qb.update(payment_entry_deduction).set(payment_entry_deduction.is_exchange_gain_loss, 1).join(
		payment_entry,
