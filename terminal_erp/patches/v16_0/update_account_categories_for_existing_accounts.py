...
from terminal_erp.accounts.doctype.account.chart_of_accounts.chart_of_accounts import get_chart_metadata_fields
from terminal_erp.accounts.doctype.account.chart_of_accounts.verified import standard_chart_of_accounts
...
def update_account_categories():
	...
	companies = terminal_framework.get_all("Company", pluck="name")
	...
	terminal_framework.db.bulk_update("Account", mapped_account_categories)
