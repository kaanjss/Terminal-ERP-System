...
def execute():
	...
	for doctype in customer_doctypes:
		customer_doctype = terminal_framework.qb.DocType(doctype)
		(
			terminal_framework.qb.update(customer_doctype)
	...
	for doctype in supplier_doctypes:
		supplier_doctype = terminal_framework.qb.DocType(doctype)
		(
			terminal_framework.qb.update(supplier_doctype)
