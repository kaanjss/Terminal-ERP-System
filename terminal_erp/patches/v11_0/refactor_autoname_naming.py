...
def set_series(doctype, value):
	doc = terminal_framework.db.exists("Property Setter", {"doc_type": doctype, "property": "autoname"})
	if doc:
		terminal_framework.db.set_value("Property Setter", doc, "value", value)
	else:
...
def get_series_to_preserve(doctype):
	series_to_preserve = terminal_framework.db.get_value("DocType", doctype, "autoname")
