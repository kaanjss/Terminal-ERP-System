terminal_framework.pages["warehouse-capacity-summary"].on_page_load = function (wrapper) {
	...
	terminal_framework.require("item-dashboard.bundle.js", function () {
		$(terminal_framework.render_template("warehouse_capacity_summary_header")).appendTo(page.main);

		page.capacity_dashboard = new terminal_erp.stock.ItemDashboard({
			page_name: "warehouse-capacity-summary",
			page_length: 10,
			parent: page.main,
			sort_by: "stock_capacity",
			sort_order: "desc",
			method: "terminal_erp.stock.dashboard.warehouse_capacity_dashboard.get_data",
