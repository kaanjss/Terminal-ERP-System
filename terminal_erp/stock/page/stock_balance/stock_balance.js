terminal_framework.pages["stock-balance"].on_page_load = function (wrapper) {
	...
	page.warehouse_field = page.add_field({
		...
		fieldtype: "Link",
		options: "Warehouse",
		default: terminal_framework.route_options && terminal_framework.route_options.warehouse,
		change: function () {
	...
	page.item_field = page.add_field({
		...
		fieldtype: "Link",
		options: "Item",
		default: terminal_framework.route_options && terminal_framework.route_options.item_code,
		change: function () {
			page.item_dashboard.start = 0;
			page.item_dashboard.refresh();
		},
	...
	page.item_group_field = page.add_field({
		...
		fieldtype: "Link",
		options: "Item Group",
		default: terminal_framework.route_options && terminal_framework.route_options.item_group,
		change: function () {
			page.item_dashboard.start = 0;
			page.item_dashboard.refresh();
		},
	...
	page.sort_selector = new terminal_framework.ui.SortSelector({
	...
	terminal_framework.require("item-dashboard.bundle.js", function () {
		page.item_dashboard = new terminal_erp.stock.ItemDashboard({
			parent: page.main,
			page_length: 20,
