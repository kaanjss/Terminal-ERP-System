...
from terminal_erp.stock.report.stock_analytics.stock_analytics import execute, get_period_date_ranges
...
class TestStockAnalyticsReport(Terminal ERPTestSuite):
	def setUp(self) -> None:
	...
	def assert_single_item_report(self, movement, expected_buckets):
		...
		row = terminal_framework._dict(data[0])
