...
from terminal_erp.stock.report.stock_ledger_invariant_check.stock_ledger_invariant_check import execute
...
class TestStockLedgerInvariantCheck(Terminal ERPTestSuite):
	def run_report(self, **extra):
		filters = terminal_framework._dict({"company": COMPANY, "warehouse": WAREHOUSE})
		filters.update(extra)
		return execute(filters)[1]

	def make_movements(self) -> str:
		terminal_framework.db.set_value("Item", ITEM, "valuation_method", "FIFO")
