...
from terminal_erp.stock.doctype.stock_reservation_entry.test_stock_reservation_entry import (
	create_items,
	create_material_receipt,
)
from terminal_erp.stock.report.reserved_stock.reserved_stock import get_data as reserved_stock_report
from terminal_erp.tests.utils import Terminal ERPTestSuite


class TestReservedStock(Terminal ERPTestSuite):
	def setUp(self) -> None:
		super().setUp()
		self.stock_qty = 100
