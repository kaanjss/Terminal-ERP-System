...
from terminal_erp.stock.report.stock_ledger_invariant_check.stock_ledger_invariant_check import (
...
def get_data(filters=None):
	...
	valuation_method = terminal_framework.get_cached_value("Company", filters.get("company"), "valuation_method")
