...
def get_bundles(data):
	...
	bundle_dict = terminal_framework._dict()
	serial_nos_data = terminal_framework.get_all(
...
def get_incorrect_serial_nos(serial_nos_data):
	...
	total_value = terminal_framework._dict({"qty": 0, "valuation_rate": 0, "serial_no": terminal_framework.bold(_("Balance"))})

	for _serial_no, data in serial_nos_data.items():
		total_dict = terminal_framework._dict({"qty": 0, "valuation_rate": 0, "serial_no": terminal_framework.bold(_("Total"))})
