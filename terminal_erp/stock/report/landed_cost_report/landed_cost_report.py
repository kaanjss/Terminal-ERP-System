...
def get_landed_cost_vouchers(filters):
	lcv = terminal_framework.qb.DocType("Landed Cost Voucher")
	lcv_voucher = terminal_framework.qb.DocType("Landed Cost Purchase Receipt")

	query = (
		terminal_framework.qb.from_(lcv)
...
def get_vendor_invoices(landed_vouchers):
	doctype = terminal_framework.qb.DocType("Landed Cost Vendor Invoice")
