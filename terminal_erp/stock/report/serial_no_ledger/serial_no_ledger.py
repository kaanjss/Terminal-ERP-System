...
from terminal_erp.stock.doctype.serial_no.serial_no import get_serial_nos as get_serial_nos_from_sle
from terminal_erp.stock.serial_batch_bundle import get_serial_no_status
from terminal_erp.stock.stock_ledger import get_stock_ledger_entries
...
def get_data(filters):
	...
	for row in stock_ledgers:
		...
		args.party = (
			terminal_framework.db.get_value(row.voucher_type, row.voucher_no, party_field) if party_field else None
		)
