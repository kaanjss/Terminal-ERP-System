...
from terminal_framework.utils import add_to_date, flt, today

from terminal_erp.stock.report.stock_ledger.stock_ledger import execute as stock_ledger_execute
...
def get_data(filters) -> list[dict]:
	...
	flt_precision = terminal_framework.db.get_default("float_precision") or 2
...
def get_warehouses(filters):
	...
	return terminal_framework.get_all("Warehouse", fields=["name", "company"], filters=warehouse_filters)
...
def get_batches(filters):
	...
	return terminal_framework.get_all("Batch", pluck="name", filters=batch_filters)
