# Copyright (c) 2013, Terminal Framework Technologies Pvt. Ltd. and Contributors and contributors
...
def execute(filters=None):
	...
	for doctype in (
		...
		all_boms = {}
		for d in terminal_framework.get_all(doctype, fields=["parent", "item_code"]):
