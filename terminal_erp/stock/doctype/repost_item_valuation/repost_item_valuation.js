...
terminal_framework.ui.form.on("Repost Item Valuation", {
	setup: function (frm) {
	...
	setup_realtime_progress: function (frm) {
		terminal_framework.realtime.on("item_reposting_progress", (data) => {
	...
	execute_reposting(frm) {
		frm.add_custom_button(__("Start Reposting"), () => {
			terminal_framework.call({
				method: "terminal_erp.stock.doctype.repost_item_valuation.repost_item_valuation.execute_repost_item_valuation",
				callback: function () {
					terminal_framework.msgprint(__("Reposting has been started in the background."));
				},
			});
		});
	},
