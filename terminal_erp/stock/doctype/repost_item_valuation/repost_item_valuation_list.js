terminal_framework.listview_settings["Repost Item Valuation"] = {
	...
	onload: function (listview) {
		var method =
			"terminal_erp.stock.doctype.repost_item_valuation.repost_item_valuation.bulk_restart_reposting";
