...
def on_doctype_update():
	terminal_framework.db.add_index("Serial and Batch Entry", ["warehouse", "batch_no", "posting_datetime"])
	terminal_framework.db.add_index("Serial and Batch Entry", ["warehouse", "serial_no", "posting_datetime"])
