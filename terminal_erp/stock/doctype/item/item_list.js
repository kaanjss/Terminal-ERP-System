terminal_framework.listview_settings["Item"] = {
	add_fields: [
		"item_name",
		"stock_uom",
		"item_group",
	...
	get_indicator: function (doc) {
		...
		} else if (doc.end_of_life && doc.end_of_life < terminal_framework.datetime.get_today()) {
...
terminal_framework.help.youtube_id["Item"] = "qXaEwld4_Ps";
