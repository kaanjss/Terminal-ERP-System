...
class DeprecatedSerialNoValuation:
	@deprecated(
		"terminal_erp.stock.serial_batch_bundle.SerialNoValuation.calculate_stock_value_from_deprecarated_ledgers",
		"unknown",
		"v16",
	...
	@deprecated(
		"terminal_erp.stock.serial_batch_bundle.SerialNoValuation.get_incoming_value_for_serial_nos",
		"unknown",
		"v16",
		"No known instructions.",
	)
	def get_incoming_value_for_serial_nos(self, serial_nos):
		...
		do_not_fetch_rate = terminal_framework.db.get_single_value(
			"Stock Reposting Settings", "do_not_fetch_incoming_rate_from_serial_no"
		)

		for serial_no in serial_nos:
			sn_details = terminal_framework.db.get_value("Serial No", serial_no, ["purchase_rate", "company"], as_dict=1)
			if (
				sn_details
				and sn_details.purchase_rate
				and sn_details.company == self.sle.company
				and (not terminal_framework.flags.through_repost_item_valuation or not do_not_fetch_rate)
			):
...
class DeprecatedBatchNoValuation:
	@deprecated(
		"terminal_erp.stock.serial_batch_bundle.BatchNoValuation.calculate_avg_rate_from_deprecarated_ledgers",
		"unknown",
		"v16",
		"No known instructions.",
	)
	...
	@deprecated(
		"terminal_erp.stock.serial_batch_bundle.BatchNoValuation.get_sle_for_batches",
		"unknown",
		"v16",
		"No known instructions.",
	)
	...
	@deprecated(
		"terminal_erp.stock.serial_batch_bundle.BatchNoValuation.calculate_avg_rate_for_non_batchwise_valuation",
		"unknown",
		"v16",
		"No known instructions.",
	)
	...
	@deprecated(
		"terminal_erp.stock.serial_batch_bundle.BatchNoValuation.set_balance_value_for_non_batchwise_valuation_batches",
		"unknown",
		"v16",
		"No known instructions.",
	)
	...
	@deprecated(
		"terminal_erp.stock.serial_batch_bundle.BatchNoValuation.set_balance_value_from_sl_entries",
		"unknown",
		"v16",
		"No known instructions.",
	)
	def set_balance_value_from_sl_entries(self) -> None:
		...
		if valuation_method := self.get_valuation_method(self.sle.item_code):
			if valuation_method == "Moving Average" and not terminal_framework.db.get_single_value(
	...
	def get_last_sle_for_non_batch(self):
		...
		return data[0] if data else terminal_framework._dict()

	@deprecated(
		"terminal_erp.stock.serial_batch_bundle.BatchNoValuation.set_balance_value_from_bundle",
		"unknown",
		"v16",
		"No known instructions.",
	)
	def set_balance_value_from_bundle(self) -> None:
		...
		bundle = terminal_framework.qb.DocType("Serial and Batch Bundle")
