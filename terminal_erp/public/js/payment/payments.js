...
terminal_erp.payments = class payments extends terminal_erp.stock.StockController {
	make_payment() {
		var me = this;
	...
	make_keyboard() {
		var me = this;
		$(this.$body).empty();
		$(this.$body).html(terminal_framework.render_template("pos_payment", this.frm.doc));
	...
	make_multimode_payment() {
		...
		this.payments = terminal_framework.model.add_child(this.frm.doc, "Multi Mode Payment", "payments");
	...
	show_payment_details() {
		...
		if (this.frm.doc.payments.length) {
			$.each(this.frm.doc.payments, function (index, data) {
				$(
					terminal_framework.render_template("payment_details", {
		...
		$(this.$body)
			...
			.text(
				format_currency(
					...
					terminal_framework.get_doc(":Company", this.frm.doc.company).default_currency
				)
			);
		this.update_invoice();
	}
