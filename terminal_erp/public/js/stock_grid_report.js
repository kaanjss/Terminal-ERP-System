...
terminal_erp.StockGridReport = class StockGridReport extends terminal_framework.views.TreeGridReport {
	...
	get_serialized_buying_rates() {
		...
		if (terminal_framework.report_dump.data["Serial No"]) {
			$.each(terminal_framework.report_dump.data["Serial No"], function (i, sn) {
