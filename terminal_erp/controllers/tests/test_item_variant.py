...
from terminal_erp.stock.doctype.item.test_item import set_item_variant_settings
...
class TestItemVariant(Terminal ERPTestSuite):
...
def make_item_variant():
	terminal_framework.delete_doc_if_exists("Item", "_Test Variant Item-XSL", force=1)
...
def make_quality_inspection_template():
	...
	if terminal_framework.db.exists("Quality Inspection Template", qc_template):
		return qc_template

	qc = terminal_framework.new_doc("Quality Inspection Template")
