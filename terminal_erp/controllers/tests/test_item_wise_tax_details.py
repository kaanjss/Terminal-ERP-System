...
from terminal_erp.tests.utils import Terminal ERPTestSuite, change_settings


class TestTaxesAndTotals(Terminal ERPTestSuite):
	def setUp(self):
		self.doc = terminal_framework.get_doc(
			{
	...
	def test_not_applicable_tax_in_item_tax_template(self):
		...
		template_7pct = terminal_framework.get_doc(
			{
		...
		template_19pct = terminal_framework.get_doc(
			{
				"doctype": "Item Tax Template",
