...
class TestWebsiteListForContact(Terminal ERPTestSuite):
	def test_get_list_context_currency_symbols(self):
		# get_list_context builds the enabled-currency symbol map via terminal_framework.get_all (converted from
	...
	def test_rfq_transaction_list_returns_supplier_rfq(self):
		...
		from terminal_erp.controllers.website_list_for_contact import rfq_transaction_list
