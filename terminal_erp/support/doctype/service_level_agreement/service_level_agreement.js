...
terminal_framework.ui.form.on("Service Level Agreement", {
	setup: function (frm) {
	...
	fetch_status_fields: function (frm) {
		...
		if (frm.doc.document_type) {
			terminal_framework.model.with_doctype(frm.doc.document_type, () => {
				let statuses = terminal_framework.meta.get_docfield(
					frm.doc.document_type,
					"status",
					frm.doc.name
				).options;
