...
from terminal_erp.support.doctype.warranty_claim.warranty_claim import make_maintenance_visit
from terminal_erp.tests.utils import Terminal ERPTestSuite


class TestWarrantyClaim(Terminal ERPTestSuite):
	...
	def test_on_cancel_blocked_by_active_maintenance_visit(self):
		...
		self.assertRaises(terminal_framework.ValidationError, claim.on_cancel)
	...
	def test_on_cancel_allowed_when_no_active_visit(self):
		...
		self.assertEqual(terminal_framework.db.get_value("Warranty Claim", claim.name, "status"), "Cancelled")
