...
from terminal_erp.support.doctype.issue.test_issue import create_customer, make_issue
from terminal_erp.support.doctype.service_level_agreement.test_service_level_agreement import (
	create_service_level_agreements_for_issues,
)
from terminal_erp.support.report.issue_analytics.issue_analytics import execute
from terminal_erp.tests.utils import Terminal ERPTestSuite

months = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"]


class TestIssueAnalytics(Terminal ERPTestSuite):
	def setUp(self):
...
def create_issue_types():
	for entry in ["Bug", "Service Request", "Discomfort"]:
		if not terminal_framework.db.exists("Issue Type", entry):
			terminal_framework.get_doc({"doctype": "Issue Type", "__newname": entry}).insert()
