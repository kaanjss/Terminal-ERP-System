...
from terminal_framework.utils import get_datetime, getdate

from terminal_erp.support.doctype.issue.test_issue import make_issue
from terminal_erp.support.report.support_hour_distribution.support_hour_distribution import execute
from terminal_erp.tests.utils import Terminal ERPTestSuite


class TestSupportHourDistribution(Terminal ERPTestSuite):
	def test_issue_buckets_into_expected_time_slot(self):
		...
		terminal_framework.db.set_value("Issue", issue.name, "creation", creation, update_modified=False)
		...
		expected = terminal_framework.db.count("Issue", {"creation": ["between", [slot_start, slot_end]]})
