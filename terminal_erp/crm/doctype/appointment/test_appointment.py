...
def create_test_appointment():
	test_appointment = terminal_framework.get_doc(
		{
			"doctype": "Appointment",
			"status": "Open",
...
class TestAppointment(Terminal ERPTestSuite):
	def setUp(self):
		terminal_framework.db.delete("Lead", {"email_id": LEAD_EMAIL})
	...
	def test_calendar_event_created(self):
		cal_event = terminal_framework.get_doc("Event", self.test_appointment.calendar_event)
