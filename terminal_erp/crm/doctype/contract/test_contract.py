...
class TestContract(Terminal ERPTestSuite):
	def setUp(self):
	...
	def test_validate_start_date_before_end_date(self):
		...
		self.assertRaises(terminal_framework.ValidationError, self.contract_doc.insert)
...
def get_contract():
	doc = terminal_framework.new_doc("Contract")
