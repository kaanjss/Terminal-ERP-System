...
terminal_framework.ui.form.on("Contract", {
	contract_template: function (frm) {
		if (frm.doc.contract_template) {
			terminal_framework.call({
				method: "terminal_erp.crm.doctype.contract_template.contract_template.get_contract_template",
				args: {
	...
	party_name: function (frm) {
		...
		terminal_framework.db.get_value(frm.doc.party_type, frm.doc.party_name, field, (r) => {
