...
from terminal_erp.crm.report.sales_pipeline_analytics.sales_pipeline_analytics import execute
from terminal_erp.tests.utils import Terminal ERPTestSuite


class TestSalesPipelineAnalytics(Terminal ERPTestSuite):
	def setUp(self):
		create_opportunity()
...
def create_opportunity():
	doc = terminal_framework.db.exists({"doctype": "Opportunity", "party_name": "_Test NC"})
	if not doc:
		doc = terminal_framework.new_doc("Opportunity")
		doc.opportunity_from = "Customer"
		customer_name = terminal_framework.db.get_value("Customer", {"customer_name": "_Test NC"}, ["customer_name"])
