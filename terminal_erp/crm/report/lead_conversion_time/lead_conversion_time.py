...
from terminal_framework.utils import date_diff, flt
...
def get_communication_details(filters):
	...
	communication_list = []
	opportunities = terminal_framework.db.get_values(
		"Opportunity",
	...
	comm = terminal_framework.qb.DocType("Communication")
	...
	for d in opportunities:
		...
		communication_count = (
			terminal_framework.qb.from_(comm)
			.select(Count("*"))
		...
		support_tickets = len(terminal_framework.db.get_all("Issue", {"raised_by": d.contact_email}))
