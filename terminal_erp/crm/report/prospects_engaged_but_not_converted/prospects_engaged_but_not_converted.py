...
def get_data(filters):
	...
	leads = terminal_framework.get_all("Lead", fields=["name", "lead_name", "company_name"], filters=lead_filters)
	if not leads:
		return lead_details
