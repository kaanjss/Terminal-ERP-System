from terminal_erp.crm.report.opportunity_summary_by_sales_stage.opportunity_summary_by_sales_stage import (
	execute,
)
from terminal_erp.crm.report.sales_pipeline_analytics.test_sales_pipeline_analytics import (
	create_opportunity,
)
from terminal_erp.tests.utils import Terminal ERPTestSuite


class TestOpportunitySummaryBySalesStage(Terminal ERPTestSuite):
	def setUp(self):
		create_opportunity()
