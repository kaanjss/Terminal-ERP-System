...
from terminal_framework.utils import cstr, filter_strip_join
...
class SalesPartner(WebsiteGenerator):
	...
	def get_context(self, context):
		address_names = terminal_framework.db.get_all(
			"Dynamic Link",
		...
		for address_name in address_names:
			address_doc = terminal_framework.get_doc("Address", address_name)
