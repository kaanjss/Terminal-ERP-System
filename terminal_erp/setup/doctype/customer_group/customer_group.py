...
class CustomerGroup(NestedSet):
	...
	def validate_currency_for_receivable_and_advance_account(self):
		for x in self.accounts:
			...
			if x.account:
				receivable_account_currency = terminal_framework.get_cached_value(
...
def get_parent_customer_groups(customer_group):
	lft, rgt = terminal_framework.db.get_value("Customer Group", customer_group, ["lft", "rgt"])
...
def on_doctype_update():
	terminal_framework.db.add_index("Customer Group", ["lft", "rgt"])
