...
terminal_framework.ui.form.on("Holiday List", {
	...
	from_date: function (frm) {
		if (frm.doc.from_date && !frm.doc.to_date) {
			var a_year_from_start = terminal_framework.datetime.add_months(frm.doc.from_date, 12);
			frm.set_value("to_date", terminal_framework.datetime.add_days(a_year_from_start, -1));
		}
	},
...
terminal_framework.tour["Holiday List"] = [
	{
