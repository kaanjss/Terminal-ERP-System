...
class Driver(Document):
	...
	if TYPE_CHECKING:
		...
		from terminal_erp.setup.doctype.driving_license_category.driving_license_category import (
	...
	def validate(self):
		if self.employee:
			self.user = terminal_framework.get_value("Employee", self.employee, "user_id")
