...
from terminal_erp.regional.report.irs_1099.irs_1099 import get_street_address_html
from terminal_erp.tests.utils import Terminal ERPTestSuite


class TestIRS1099StreetAddress(Terminal ERPTestSuite):
	def test_street_address_prefers_postal(self):
		...
		if not terminal_framework.db.exists("Supplier", party):
