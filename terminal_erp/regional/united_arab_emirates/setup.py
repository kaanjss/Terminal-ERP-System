...
def add_print_formats():
	terminal_framework.reload_doc("regional", "print_format", "detailed_tax_invoice")
	terminal_framework.reload_doc("regional", "print_format", "simplified_tax_invoice")
	terminal_framework.reload_doc("regional", "print_format", "tax_invoice")

	pf = terminal_framework.qb.DocType("Print Format")
	(
		terminal_framework.qb.update(pf)
		.set(pf.disabled, 0)
...
def add_custom_roles_for_reports():
	...
	if not terminal_framework.db.get_value("Custom Role", dict(report="UAE VAT 201")):
