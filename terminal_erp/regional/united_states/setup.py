...
def setup(company=None, patch=True):
	...
	if terminal_framework.db.count("Company", {"country": "United States"}) <= 1:
...
def add_print_formats():
	terminal_framework.reload_doc("regional", "print_format", "irs_1099_form")
	terminal_framework.db.set_value("Print Format", "IRS 1099 Form", "disabled", 0)
